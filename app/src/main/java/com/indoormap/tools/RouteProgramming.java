...
//
//    //用于导航的路径
//    private static int[] pathRout={35,86,630,86,
//                                   530,86,530,175,
//                                   530,175,728,175,
//                                   728,175,728,690,};
//
...
//
//    //路径数据初始化,加载进内存
//    public RouteProgramming(Context context, String start, String end){
...
//            //将路径数据加载进内存
//            for(int i=0;i<pathRout.length/4;i++){
//                int boundary1=pathRout[4*i];
//                int boundary2=pathRout[4*i+1];
//                int boundary3=pathRout[4*i+2];
//                int boundary4=pathRout[4*i+3];
...
//        RouteProgramming routePlanning =new RouteProgramming();
